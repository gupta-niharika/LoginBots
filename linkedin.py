...
class Linkedinbot:
    ...
    def login(self):
        ...
        #create a post
        self.driver.find_element_by_xpath('//*[@id="ember46"]/div/div[1]/button').click()     #46/47
        self.driver.find_element_by_xpath('/html/body/div[4]/div/div/div[2]/div/div[1]/div[1]/div[2]/div/div/div/div/div[1]').send_keys('this is post 18 by kitanu')   #/div/div[1]
        ...
        self.driver.find_element_by_xpath('/html/body/div[4]/div/div/div[2]/div/div[1]/div[1]/div[2]/div/div/div/div/div[1]').send_keys('this is post 19 by kitanu')   #/div/div[1]
        self.driver.find_element_by_xpath('/html/body/div[4]/div/div/div[2]/div/div[2]/div[2]/button/span').click()
        

if __name__ == '__main__':
    loginbot = Linkedinbot('user@mail.com', 'mailpwd')